...
- **`job_agent.py`**: a working daily script that pulls listings (SerpAPI/Google Jobs, RSS,
...
- Resume upload, onboarding wizard (roles, location/commute/remote, industries,
  minimum salary), then an immediate scan
...
job-search-agent/
  ...
  CLAUDE.md               # style/rules/stack conventions for AI-assisted development
```
